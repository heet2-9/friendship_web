...
export default function FinalMessageScreen() {
  ...
  const messages = [
    ...
    "Through every laugh, every tear, every crazy moments...",
    "You've been my constant, my support, my partner in crime! 🎉",
    "I still remember the time we used to talk whole day without worrying about our exams 😅",
    "I hope our friendship stays forever strong like no one can apart us till the death comes!",
    "We both faced intense heartbreaks but everytime we were there each other for support whether it is about Jiya or Parv",
    "And I promise you that your Mickey be always there for you whenever you need me.🥰",
    "I have never ever thought that one day you will become the person to whom i can share anything and will never judge me.🥺",
    "like aapdi friendship atli unexpected hati ki aapde 10th pehla barabar vaat bi nota karta..like total strangers for eachother",
    "But have ek divas bi vaat no karye toh no chale.",
    "hope so aapdo bond hamesha maate aavo aj strong rehse.",
    "Thank you for being the most amazing bestfriend anyone could ask for! ✨",
    "Here's 4 years of friendship, fun, and unforgettable memories! 🥳",
    "Happy Friendship Day, Mouse(Dhruvi)! 💖",
  ]
